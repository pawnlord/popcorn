...
void mem_init(){
  ...
  kasserteq(((uint32_t*)(kernel_page_dir[0] & ~0b111))[0], 0x0 | 0b111, "kernel page 0 not identity paged");
  idpage(1024*0x1000, 1024*0x1000, kernel_page_dir);
  kasserteq(((uint32_t*)(kernel_page_dir[1] & ~0b111))[0], 1024*0x1000 | 0b111, "kernel page 1 not identity paged");
