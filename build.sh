...
ld -m elf_i386 -T link.ld -o bin/kernel bin/kasm.o bin/kc.o bin/kmalloc.o bin/display.o bin/testing.o bin/buddy.o
rm bin/kasm.o  bin/kc.o bin/kmalloc.o bin/display.o bin/testing.o bin/buddy.o
