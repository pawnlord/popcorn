...
build_file "exec"
build_file task
ld -m elf_i386 -T link.ld -o bin/kernel bin/kasm.o bin/kc.o bin/kmalloc.o bin/display.o bin/testing.o bin/buddy.o bin/kio.o bin/task.o bin/ksh.o bin/_asm_task.o "bin/exec.o"
