...
nasm -f elf32 asm/interrupt.s -o bin/interrupt.o
build_file(){
...
build_file "exec"
build_file task
ld -m elf_i386 -T link.ld -o bin/kernel bin/kasm.o bin/_asm_task.o bin/interrupt.o  bin/kc.o bin/kmalloc.o bin/display.o bin/testing.o bin/buddy.o bin/kio.o bin/task.o bin/ksh.o "bin/exec.o"
